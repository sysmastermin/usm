    ...
    if (!sceneImage) {
        return (
            <div className="text-center py-20">
                <h2 className="text-2xl font-bold mb-4">이미지를 찾을 수 없습니다</h2>
                <Link to="/scene" className="text-blue-600 hover:underline">
                    씬 페이지로 돌아가기
                </Link>
            </div>
        );
            ...
            >
                <div className="border-t border-gray-200 dark:border-gray-800 pt-8 md:pt-12">
                    <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 mb-4">
                        온라인 쇼핑몰에 게시된 제품 외의<br />
                        커스터마이즈 주문을 원하시거나<br />
                        기타 문의사항이 있으시면 아래로 연락주세요.
                    </p>
                    <div className="text-sm md:text-base">
                        <p className="font-medium mb-2">문의처</p>
                        <p className="text-gray-600 dark:text-gray-400">050-5050-9850</p>
